...
export default function LoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Only allow ADMIN users into this panel
      if (user.role !== 'ADMIN') {
      ...
      // Persist token + user for auth guard and UI
      saveAuth(token, user);
        ...
        >
          ...
          <div className="space-y-4">
            <div className="inline-flex items-center gap-2 bg-primary/5 px-4 py-2 rounded-full border border-primary/10">
              ...
              <span className="text-[10px] font-black uppercase tracking-[0.2em] text-primary">Secure Admin Portal</span>
            </div>
            ...
            <p className="text-xs font-bold text-foreground-nadif/40 uppercase tracking-widest">
